...
int main()
{
	...
	while (1)
		{
			cout << "Hello what would you like to do\n (1) to add a node \n  (2) to remove a node \n (3) To delete the whole tree  \n (4) to display the BST Tree \n   (5) to find first common parent of 2 nodes \n Anything else to leave" << endl;
			cin >> choose;
			switch (choose)
			{
			case 1:
			...
			case 4:
				...
				int uno, dos;
					...
					cin >> dos;
					cout <<"first parrent of " << uno<< " and "<< dos<< "is " << myBST.firstCommonParent(myBST.root, uno, dos);
					break;
			default:
				cout << "Goodbye" << endl;
        break;
